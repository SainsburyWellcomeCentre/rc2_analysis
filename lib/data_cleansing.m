...
for sess_i = 1 : length(sessions)
    if any(strcmp(sessions(sess_i).session_id, {'CAA-1112872_rec1_001', 'CAA-1112872_rec1b_001', 'CAA-1112872_rec2_001', ...
       ...
       ~isempty(regexp(sessions(sess_i).session_id, 'CAA-111624', 'once'))
...
if strcmp(sessions(1).session_id, 'CAA-1123243_rec1_001') || ...
        strcmp(sessions(1).session_id, 'CAA-1123244_rec1_001') || ...
        strcmp(sessions(1).session_id, 'CAA-1123245_rec1_001') || ...
        strcmp(sessions(1).session_id, 'CAA-1123246_rec1_001') || ...
...
if strcmp(sessions(2).session_id, 'CAA-1124370_rec2_001') || ...
        ...
        strcmp(sessions(2).session_id, 'CAA-1124718_rec2_001')

    fname = 'Z:\mvelez\mateoData_rc2\passive_protocol_sequence_motion_clouds_goggles.mat';
