classdef Trial < handle
    ...
    methods
        ...
        %%currently monolithic class for a trial
...
%             bouts = bouts([bouts(:).duration] > obj.min_bout_duration);
        ...
        %%probe time on which the mismatch occurs
        ...
        %%probe time on which the mismatch starts to ramp down
        ...
        %%get the sample on which the mismatch onset occurs
        ...
        %%is the current trial a mismatch trial 
        ...
        %%duration of the mismatch between starting to ramp up and starting
        %%to ramp down
        ...
        %%get the trial to which this trial should be aligned... makes
        %%Trial call Session and back, which is a bit ugly but makes life
        %%easy
