...
%          2. several methods need to cope with the event that a file does exist
    ...
    methods
        ...
        %   loads the automated Bombcell curation .csv (possibly hand-edited)
        %   for probe recording PROBE_ID and returns it as a MATLAB table,
        %   TABLE. The `keep` column drives cluster selection.
