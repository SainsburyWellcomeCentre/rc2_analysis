classdef TrialStructurePosition < handle
% TrialStructurePosition Class for plotting the structure of RVT trials.
%
%  TrialStructurePosition Properties:
...
%
%  TrialStructurePosition Methods:
%       plot_treadmill      - plots the treadmill velocity
%       plot_position       - plots the position
...
%
%   The TrialStructurePosition class takes information about a trial and plots the
%   breakdown of the trial. This includes separate axes for treadmill,
%   positon and linear stage speeds, as well as the camera motion energy and
...
%   See also: Trial, Cluster
    ...
    methods
        ...
        function obj = TrialStructurePosition()
        ...
        function plot_position(obj, h_ax)
        %%plot_position Plots the position
        
            obj.plot_general_trace(h_ax, obj.trial.position, 'Position (cm)');
        end
        ...
        %   one of 'treadmill', 'position', 'stage', 'camera', and 'fr'.
