...
input_csv = fullfile('C:','Users','lee','Documents','mvelez','figures','motionClouds_mouseGoggles','passive_same_luminance_mc','stationary_vs_motion_orientations','single_cluster','motion_cloud_orientations_analysis_summary.csv');
...
out_dir = fullfile('C:','Users','lee','Documents','mvelez','figures','motionClouds_mouseGoggles','passive_same_luminance_mc','stationary_vs_motion_orientations','population');
